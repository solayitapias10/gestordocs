...
DROP TRIGGER IF EXISTS tri_act_usuarios ON usuarios;
DROP TRIGGER IF EXISTS tri_act_solicitudes_registro ON solicitudes_registro;
DROP TRIGGER IF EXISTS tri_act_carpetas ON carpetas;
DROP TRIGGER IF EXISTS tri_act_archivos ON archivos;
DROP TRIGGER IF EXISTS tri_act_compartidos ON compartidos;
DROP TRIGGER IF EXISTS tri_act_solicitudes_compartidos ON solicitudes_compartidos;
DROP TRIGGER IF EXISTS tri_act_notificaciones ON notificaciones;
DROP TRIGGER IF EXISTS tri_act_tokens_recuperacion ON tokens_recuperacion;
...
-- Eliminar funciones
DROP FUNCTION IF EXISTS fun_act_tab();
...
-- =====================================================
-- CREACIÓN DE TABLAS CON CAMPOS DE AUDITORÍA INTEGRADOS
-- =====================================================
...
CREATE TABLE usuarios (
    ...
    fec_insert TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    usr_update VARCHAR(100),
    fec_update TIMESTAMP WITH TIME ZONE,
...
BEGIN
    RAISE NOTICE '====================================================';
    RAISE NOTICE 'SISTEMA DE GESTIÓN DE ARCHIVOS INSTALADO EXITOSAMENTE';
    RAISE NOTICE '====================================================';
    RAISE NOTICE 'Tablas creadas: 8 (con campos de auditoría integrados)';
    RAISE NOTICE 'Triggers del sistema: 3';
    RAISE NOTICE 'Triggers de auditoría: 8';
