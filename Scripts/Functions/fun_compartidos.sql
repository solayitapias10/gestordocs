...
RETURNS TABLE (
    ...
    estado solicitudes_compartidos.estado%TYPE,
    id_archivo archivos.id%TYPE,
    id_usuario archivos.id_usuario%TYPE,    -- AGREGADO: ID del propietario
    id_carpeta archivos.id_carpeta%TYPE,    -- AGREGADO: ID de la carpeta
    nombre_archivo archivos.nombre%TYPE,
    tipo archivos.tipo%TYPE,
    tamano archivos.tamano%TYPE,
    propietario usuarios.nombre%TYPE,
...
BEGIN
    ...
    SELECT 
        ...
        d.estado,
        a.id as id_archivo,
        a.id_usuario,                       -- AGREGADO: Retorna el ID del propietario
        a.id_carpeta,                       -- AGREGADO: Retorna el ID de la carpeta
        a.nombre as nombre_archivo,
        a.tipo,
        a.tamano,
        COALESCE(u_propietario.nombre, 'Usuario sin nombre') as propietario,
